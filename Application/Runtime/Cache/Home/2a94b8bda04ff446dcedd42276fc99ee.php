...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="/shopdemo2/Public/css/style.css" rel="stylesheet" type="text/css" />
        
    </head>
    <body class="index_body">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top"><img class="logo" src="/shopdemo2/Public/images/logo.gif"></a>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" action="#">
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('/shopdemo2/Public/images/sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;" type="submit" />
        ...
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <img src="/shopdemo2/Public/images/biao6.gif" />
                    北京市区，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>
            </div>
            <div class="f_r" style="padding-right: 10px;">
                <img style="vertical-align: middle;" src="/shopdemo2/Public/images/biao3.gif">
                    <span class="cart" id="ECS_CARTINFO">
                        <a href="#" title="查看购物车">您的购物车中有 0 件商品，总计金额 ￥0.00元。</a></span>
                    <a href="#"><img style="vertical-align: middle;" src="/shopdemo2/Public/images/biao7.gif"></a>
        ...
        <div class="block clearfix">
                ...
                <div class="box">
                    ...
                    <div class="box_1">
                        <div class="top10List clearfix">
                            <ul class="clearfix">
                                <img src="/shopdemo2/Public/images/top_1.gif" class="iteration">
                                    <li class="topimg">
                                        <a href="#"><img src="/shopdemo2/Public/images/3_thumb_G_1241422082679.jpg" alt="" class="samllimg"></a>
                                    </li>
                            ...
                            <ul class="clearfix">
                                <img src="/shopdemo2/Public/images/top_2.gif" class="iteration">
                                    <li class="topimg">
                                        <a href="#"><img src="/shopdemo2/Public/images/24_thumb_G_1241971981429.jpg" alt="" class="samllimg"></a>
                                    </li>
                            ...
                            <ul class="clearfix">
                                <img src="/shopdemo2/Public/images/top_3.gif" class="iteration">
                                    <li class="topimg">
                                        <a href="#"><img src="/shopdemo2/Public/images/12_thumb_G_1241965978410.jpg" alt="" class="samllimg"></a>
                                    </li>
                            ...
                            <ul class="clearfix">
                                <img src="/shopdemo2/Public/images/top_4.gif" class="iteration">
                            ...
                            <ul class="clearfix">
                                <img src="/shopdemo2/Public/images/top_5.gif" class="iteration">
                            ...
                            <ul class="clearfix">
                                <img src="/shopdemo2/Public/images/top_6.gif" class="iteration">
                            ...
                            <ul class="clearfix">
                                <img src="/shopdemo2/Public/images/top_7.gif" class="iteration">
                ...
                <div class="blank5"></div><div class="box">  <h3><span>品牌专区</span></h3>
                    <div class="box_1">
                        <div class=" brands clearfix">
                            <a href="#"><img src="/shopdemo2/Public/images/1240803062307572427.gif" alt="诺基亚 (7)"></a>
                            <a href="#"><img src="/shopdemo2/Public/images/1240802922410634065.gif" alt="摩托罗拉 (1)"></a>
                            <a href="#"><img src="/shopdemo2/Public/images/1240803144788047486.gif" alt="多普达 (1)"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="AreaM">
                <div class="box clearfix">
                    <div id="focus">
                        <img src="/shopdemo2/Public/images/111.jpg" width="515" height="160" alt="" />
                    </div>       
                </div>
                <div class="blank"></div>
                ...
                <div id="show_hot_area" class="clearfix">
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="/shopdemo2/Public/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="goodsimg"></a><br />
                    ...
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="/shopdemo2/Public/images/1_thumb_G_1240902890710.jpg" alt="KD876" class="goodsimg"></a><br />
                    ...
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="/shopdemo2/Public/images/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="goodsimg"></a><br />
        ...
        <div class="blank"></div>
        <div class="block">
            <a href="#" target="_blank" title="YONGDA商城"><img alt="YONGDA商城" src="/shopdemo2/Public/images/di.jpg"></a>
            <div class="blank"></div>
        </div>
        <div class="block">
            <div class="box">
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/shopdemo2/Public/images/ecshop_logo.gif" alt="YONGDA商城" border="0"></a>

                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="/shopdemo2/Public/images/ecshop_logo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
