...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="/shopdemo2/Public/Admin/css/User_Login.css" type="text/css" rel="stylesheet" />
        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="<?php echo U('Manager/login');?>" method="post">
                        <ul>
                                ...
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="<?php echo U('Manager/verifyImg');?>"  alt="" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="user_main_r">
                                ...
                                <input style="border: medium none; background: url('/shopdemo2/Public/Admin/img/user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
